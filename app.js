...
(function() {
    ...
    function app() {
        ...
        queue()
            .defer(d3.json, "https://raw.githubusercontent.com/scrab017/d3p/master/india_pc_2014.json")
            .defer(d3.json, "https://raw.githubusercontent.com/scrab017/d3p/master/Admin2_Topo.json")
            .defer(d3.csv, "https://raw.githubusercontent.com/scrab017/d3p/master/representation.csv")
            .await(ready);
